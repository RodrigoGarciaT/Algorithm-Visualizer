...
function Navbar() {
  const { buttonState, toggleButton, solveBfs } = React.useContext(appContext)
  ...
  return (
    <nav className ="navbar">
        ...
        <div className="nav-right">
            <button onClick ={() =>solveBfs()}className="nav-button">Solve with BFS</button>
            <button className="nav-button">Solve with Dijkstra</button>
